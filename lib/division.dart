...
class DivisionPage extends StatefulWidget {
  ...
  @override
  _DivisionPageState createState() => new _DivisionPageState();
}
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: GridView.count(
                  ...
                  children: List.generate(divisionList.length, (index) {
                    return TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => VehicleListPage(
                                  fromPage: 'division',
                                  fromWhere: divisionList[index].toString())),
                        );
                      },
                      child: Padding(
                          ...
                          child: Padding(
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  Center(child: Text(divisionList[index])),
                                  const Padding(
